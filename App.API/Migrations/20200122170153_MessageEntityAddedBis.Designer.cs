...
namespace App.API.Migrations
{
    ...
    [Migration("20200122170153_MessageEntityAddedBis")]
    partial class MessageEntityAddedBis
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.API.Models.Like", b =>
                {
            ...
            modelBuilder.Entity("App.API.Models.Like", b =>
                {
                    b.HasOne("App.API.Models.User", "Likee")
                        .WithMany("Likers")
                        .HasForeignKey("LikeeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("App.API.Models.User", "Liker")
                        .WithMany("Likees")
            ...
            modelBuilder.Entity("App.API.Models.Message1", b =>
                {
                    ...
                    b.HasOne("App.API.Models.User", "Sender")
